...
CREATE TABLE FoodCategory (
    FoodCategoryId INT GENERATED BY DEFAULT ON NULL AS IDENTITY,
	Name NVARCHAR2(40) NOT NULL UNIQUE,
    constraint FOODCATEGORY_PK PRIMARY KEY (FoodCategoryId));

/
CREATE TABLE Discount (
    DiscountId INT GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
ALTER TABLE Discount ADD CONSTRAINT Discount_fk0 FOREIGN KEY (FoodCategoryId) REFERENCES FoodCategory(FoodCategoryId);
ALTER TABLE FoodItem ADD CONSTRAINT FoodItem_fk0 FOREIGN KEY (FoodCategoryId) REFERENCES FoodCategory(FoodCategoryId);
