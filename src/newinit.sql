...
DROP TABLE ScheduleItem cascade constraints;
...
CREATE TABLE ScheduleItem (
	ScheduleItemId INT GENERATED BY DEFAULT ON NULL AS IDENTITY,
	ScheduleId INT,
	WeekDay NVARCHAR(40) NOT NULL,
	StartTime NVARCHAR(40) NOT NULL,
	EndTime TIMESTAMP NOT NULL,
	constraint SCHEDULE_PK PRIMARY KEY (ScheduleItemId));
...
ALTER TABLE ScheduleItem ADD CONSTRAINT ScheduleItem_fk0 FOREIGN KEY (ScheduleId) REFERENCES Schedule(ScheduleId);
